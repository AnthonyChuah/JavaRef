...
class ArrayTest {
	...
	ArrayTest aTest = new ArrayTest(10);
	Integer[] testInput = new Integer[10];
	for (int i = 0; i < testInput.length; ++i) {
	    testInput[i] = i;
	}
	aTest.populateTestArray(testInput);
	System.out.println("Testing populateTestArray: should see 1 to 10: array size is: " + aTest.testArraySize());
	for (int i = 0; i < aTest.testArraySize(); ++i) {
	    System.out.print(aTest.testArray[i] + " ");
	}
    }
    ...
    public void populateTestArray(Integer[] inputIntArray) {
